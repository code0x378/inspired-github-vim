...
hi Statement guifg=#a71d6b guibg=#ffffff guisp=#ffffff gui=bold,underline ctermfg=125 ctermbg=15 cterm=bold,underline
...
hi Type guifg=#a71d6b guibg=#ffffff guisp=#ffffff gui=bold ctermfg=125 ctermbg=15 cterm=bold
